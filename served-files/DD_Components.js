...
class DD_Input extends HTMLElement {
    ...
    constructor() {
        ...
        this.input.addEventListener("change", function(event) {
            if (this.value == "" || DD_Components.isValidNumberString(this.value, thisInput.getAttribute("dd-decimal-separator"), thisInput.getAttribute("dd-thousands-separator"))) {
                if (thisInput.hasAttribute("onchange")) {
                    DD_Components.executeFunctionByName(thisElem.getAttribute("onchange"), window, thisElem, thisInput.previousValue, this.value);
                }

                thisInput.previousValue = this.value;
            } else {
                let aux = thisInput.previousValue;
                thisInput.value = thisInput.previousValue;
                thisInput.previousValue = aux;
            }
        });
    ...
    getValueAsNumber() {
        return DD_Components.isValidNumberString(this.value, thisInput.getAttribute("dd-decimal-separator"), thisInput.getAttribute("dd-thousands-separator"));
    }
