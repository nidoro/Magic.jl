...
Internally, this macro is implemented by checking the result of [`is_app_first_pass()`](/docs/build/docs/api-reference/application-logic/is_app_first_pass-func) and running the `@app_startup` code block only if it returns `true`.
