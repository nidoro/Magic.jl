...
echo "Building static library libsqlite3.dll.a"
x86_64-w64-mingw32-gcc $CFLAGS -fPIC -c -o $DEST_DIR/lib/libsqlite3.dll.a sqlite3.c -l:libSqliteIcu.dll.a -l:libicuuc.dll.a -l:libicuin.dll.a
