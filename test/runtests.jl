...
@testset "function start_app(...) input validation" begin
    @test_throws Magic.FileNotFound             start_app("__NON_EXISTING_FILE__", dot_magic_dir="../examples")
    ...
    @test_throws Magic.DirectoryNotFound        start_app("../examples/app.jl", dot_magic_dir="__NON_EXISTING_DIR__")
    @test_throws Magic.DirectoryNotFound        start_app("../examples/app.jl", docs_path="__NON_EXISTING_DIR__", dot_magic_dir="../examples")
end
